...
import { H as H3Event, t as toResponse, s as setCookie$1, p as parseCookies } from "../_libs/h3-v2.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-qVynub5O.mjs");
...
const manifest = {
  "15eaf2cbed0ae8e473c6e6904239b35d2f5bceca0bdec7014e5325c1aee32c96": {
    functionName: "detectLocale_createServerFn_handler",
    importer: () => import("./i18n.functions-D5aG41G-.mjs")
  },
  "1f3e3739e364c8f265c79b6ac4319e6f22dfc667833dab112fec7e2e22416f5c": {
    functionName: "setLocale_createServerFn_handler",
    importer: () => import("./i18n.functions-D5aG41G-.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BPwpHoBv.mjs").then((n) => n.r),
    import("./start-BWjugur1.mjs"),
