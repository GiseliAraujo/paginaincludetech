...
const PT = {
  ...
  about: {
    label: "Quem somos",
    titlePre: "Tecnologia com ",
    titleEm: "propósito",
    titlePost: " e profundidade.",
  ...
  services: {
    ...
    titleMid: " à ",
    titleEm2: "entrega",
    titlePost: ", sem furos no caminho.",
    items: [
    ...
    sectorsTitlePre: "Onde geramos ",
    sectorsTitleEm: "impacto real",
    sectorsTitlePost: ".",
    sectors: [
  ...
  products: {
    label: "Laboratório",
    titleEm: "Criações",
    titlePost: " que moldam o que vem.",
    items: [
  ...
  contact: {
    ...
    titlePre: "Tem um ",
    titleEm: "desafio",
    titlePost: " que vale a pena resolver?",
...
const EN = {
  ...
  services: {
    ...
    titleMid: " to ",
    titleEm2: "delivery",
    titlePost: ", no gaps along the way.",
    items: [
    ...
    sectorsTitlePre: "Where we create ",
    sectorsTitleEm: "real impact",
    sectorsTitlePost: ".",
    sectors: [
...
const ES = {
  ...
  about: {
    label: "Quiénes somos",
    titlePre: "Tecnología con ",
    titleEm: "propósito",
    titlePost: " y profundidad.",
  ...
  services: {
    ...
    titleMid: " a la ",
    titleEm2: "entrega",
    titlePost: ", sin baches en el camino.",
    items: [
    ...
    sectorsTitlePre: "Dónde generamos ",
    sectorsTitleEm: "impacto real",
    sectorsTitlePost: ".",
    sectors: [
  ...
  products: {
    label: "Laboratorio",
    titleEm: "Creaciones",
    titlePost: " que dan forma a lo que viene.",
    items: [
  ...
  contact: {
    ...
    titlePre: "¿Tienes un ",
    titleEm: "desafío",
    titlePost: " que vale la pena resolver?",
...
const FR = {
  ...
  about: {
    ...
    titlePre: "Une technologie avec ",
    titleEm: "du sens",
    titlePost: " et de la profondeur.",
  ...
  services: {
    ...
    titleMid: " à la ",
    titleEm2: "livraison",
    titlePost: ", sans accroc en chemin.",
    items: [
    ...
    sectorsTitlePre: "Là où nous créons ",
    sectorsTitleEm: "un impact réel",
    sectorsTitlePost: ".",
    sectors: [
  ...
  products: {
    label: "Laboratoire",
    titleEm: "Créations",
    titlePost: " qui façonnent la suite.",
    items: [
  ...
  contact: {
    label: "Contact",
    titlePre: "Vous avez un ",
    titleEm: "défi",
    titlePost: " qui vaut le coup d'être relevé ?",
...
const DICTIONARIES = { pt: PT, en: EN, es: ES, fr: FR };
function t(locale) {
...
export {
  DEFAULT_LOCALE as D,
  LOCALES as L,
  localeFromAcceptLanguage as a,
  LOCALE_LABELS as b,
  isLocale as i,
  localeFromCountry as l,
  t
};
